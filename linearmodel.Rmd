...
This test is telling us that their is an erros that occurs from the with just ARM and it added up to 217.88. The errors in the model with both ARM and GRIP added up to 188.43 showing that there is less errors in the model with both elements rather then the one with just ARM.
